...
TOOLS = [
    ...
    {"name": "write_file", "description": "Write or create a UTF-8 text file anywhere on the Windows PC. The path may be relative to WORKSPACE or an absolute Windows path. Parent directories are created automatically.", "inputSchema": {"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}}, "required": ["path", "content"], "additionalProperties": False}},
    {"name": "append_file", "description": "Append UTF-8 text to a file anywhere on the Windows PC. The path may be relative to WORKSPACE or an absolute Windows path.", "inputSchema": {"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}}, "required": ["path", "content"], "additionalProperties": False}},
    {"name": "git_status", "description": "Run git status in the configured Windows workspace.", "inputSchema": {"type": "object", "properties": {}, "additionalProperties": False}},
    {
        ...
        "inputSchema": {"type": "object", "properties": {"command": {"type": "string"}, "shell": {"type": "string", "enum": ["powershell", "cmd"], "default": "powershell"}, "timeout": {"type": "integer", "minimum": 1, "maximum": 300}}, "required": ["command"], "additionalProperties": False}
    },
]
...
def tool_call(name, arguments):
    ...
    return {"content": [{"type": "text", "text": json.dumps(result.get("result"), ensure_ascii=False)}]}
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        if method == "initialize":
            self._json(rpc_result(request_id, {"protocolVersion": "2025-06-18", "capabilities": {"tools": {}}, "serverInfo": {"name": "remote-pc-agent", "version": "2.2.0"}}))
            return
